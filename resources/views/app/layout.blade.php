                                        ...
                                        <ul class="menu-sub">
                                            <li class="menu-item">
                                                <a href="{{ route('posts') }}" class="menu-link">
                                                    ...
                                                    <div data-i18n="Postagens">Postagens</div>
                                                </a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="{{ route('medias') }}" class="menu-link">
                                                    <i class="menu-icon tf-icons ri-image-add-line"></i>
                                                    <div data-i18n="Mídia">Mídia</div>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    @if (Auth::user()->role === 'admin')
                                        <li class="menu-item">
                                            <a href="javascript:void(0)" class="menu-link menu-toggle">
                                                ...
                                                <div data-i18n="Planos & Financeiro">Planos & Financeiro</div>
                                            </a>
                                            <ul class="menu-sub">
                                                <li class="menu-item">
